...
export const PERMISSIONS: { resource: string; action: string; description: string }[] = [
  ...
  // ── Support ──
  { resource: 'support:messages', action: 'read', description: 'View contact form messages' },
  { resource: 'support:messages', action: 'write', description: 'Update contact message status' },
  // ── Discounts ──
